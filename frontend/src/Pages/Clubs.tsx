...
//             {/* Create Clubs Button */}
//             <button className="flex items-center justify-between bg-green-200 text-green-800 px-4 py-2 rounded-lg w-full max-w-sm mb-6 hover:bg-green-300 transition">
